...
static       int smartgaps          = 3;        /* 1 means no outer gap when there is only one window */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "Fantasque Sans Mono Regular:size=13" };
static const char dmenufont[]       = "Daddy Time Mono:size=15";
static const char col1[]= "#008080";
static const char col2[]= "#009a9a";
static const char col3[]= "#7fbfbf";
static const char col4[]= "#8eac9d";
static const char col_1[]     = "#300c1e";
static const char *colors[][3]      = {

	/*               fg         bg         border   */
	[SchemeNorm] = { col3,      col1,      col2 },
	[SchemeSel]  = { col4,      col_1,     col_1  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col1, "-nf", col3, "-sb", col_1, "-sf", col4, NULL };
